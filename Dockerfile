...
RUN git clone --branch develop https://github.com/LucaVignati/plc-testbench.git && cd plc-testbench && python setup.py sdist && python3 -m pip install -f ./dist plc-testbench && cp dl_models /plc-testbench-ui
