/*!
 * wavesurfer.js 6.6.1 (2023-03-18)
...
var CanvasEntry = /*#__PURE__*/function () {
  ...
  _createClass(CanvasEntry, [{
    ...
    key: "stretchCanvas",
    value: function stretchCanvas(newTotalWidth) {
      //Calculate the start and width of this canvas
      var start = Math.round(this.start * newTotalWidth);
      var width = Math.round(this.end * newTotalWidth - start);
      ...
      (0, _style.default)(this.wave, elementSize);
      (0, _style.default)(this.wave, elementStart);
      if (this.hasProgressCanvas) {
        (0, _style.default)(this.progress, elementSize);
        (0, _style.default)(this.progress, elementStart);
      }
    }
  ...
  _createClass(MultiCanvas, [{
    ...
    value: function updateSize() {
      ...
      this.canvases.forEach(function (entry, i) {
        ...
        leftOffset += canvasWidth / _this2.params.pixelRatio;
    ...
    value: function drawLine(peaks, absmax, halfH, offsetY, start, end, channelIndex) {
      ...
      this.canvases.forEach(function (entry, i) {
        ...
        if (_this6.optimiseZoom) {
          //Optimising zoom functionality
          //If there's a wrapper, optimise for the view
          var priority = 0;
          if (_this6.wrapper) {
            var canvasRect = entry.wave.getBoundingClientRect();
            var wrapperRect = _this6.wrapper.getBoundingClientRect();
            ...
            if (Math.floor(canvasRect['left']) > Math.ceil(wrapperRect['right'])) {
              ...
              var distance = canvasRect['left'] - wrapperRect['right'];
              ...
              var _distance = wrapperRect['left'] - canvasRect['right'];
              priority = Math.ceil(_distance / wrapperRect['width']);
            }
          } else {
    ...
    key: "stretchCanvases",
    value: function stretchCanvases(desiredWidth, progress) {
      if (!this.optimiseZoom) {
        //Enable optimsed zooming
        this.optimiseZoom = true;
      }
      var totalCanvasWidth = Math.round(desiredWidth / this.params.pixelRatio);
      ...
      //Update progress
      var progressPos = progress * totalCanvasWidth;
...
var WaveSurfer = /*#__PURE__*/function (_util$Observer) {
  ...
  _createClass(WaveSurfer, [{
    ...
    key: "getAndDrawPeaks",
    value: function getAndDrawPeaks(wavesurfer, width, start, end) {
      var peaks;
    ...
    key: "zooming",
    value: function zooming(pxPerSec) {
      //Calculate the new width, this cannot be smaller than the parent container width
      var desiredWidth = Math.round(this.getDuration() * pxPerSec * this.params.pixelRatio);
      var parentWidth = this.drawer.getWidth();
...
_defineProperty(WaveSurfer, "VERSION", "6.6.1");
/**
