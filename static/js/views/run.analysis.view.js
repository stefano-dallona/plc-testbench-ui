  ...
  updateCursor() {
    ...
    return function loop() {
      /*if (_view.cursorLayer) {
        ...
        _view.cursorLayer.currentPosition = (context.currentTime - startTime) % controller.bufferLoader.bufferList[0].duration
  ...
  renderSamples(data) {
    ...
    function createLegend(legendColor, lineId, legendText) {
      ...
      legendGroup.append("rect")
        ...
        .attr("x", (width + marginLegend - 45) / 1.3)
      ...
      legendGroup.append('text')
        ...
        .attr('font-size', '12px')
        .attr('fill', 'white')
        .attr("transform", "translate(" + ((width + marginLegend) / 1.3) + "," + (margin.top) + ")")
        .text("X  " + legendText)
        .on("click", function () {
